...
Many to many match for SA-1B data
"""
import torch
...
from ..utils.misc import batch_dice_loss_jit, batch_sigmoid_ce_loss
    ...
    def memory_efficient_forward(self, outputs, targets, cost=["cls", "box", "mask"]):
        ...
        for b in range(bs):
            ...
            if "cls" in cost:
                ...
                cost_class = torch.tensor(0).to(out_bbox)
            ...
            if 'mask' in cost:
                ...
                with autocast(enabled=False):
                    ...
                    cost_mask = batch_sigmoid_ce_loss(out_mask, tgt_mask)  # FIXME
