...
For visualization and demos, we recommend using [T-Rex](https://deepdataspace.com/playground/ivp), which is another visual prompting tool in our team with similar properties as ours.
